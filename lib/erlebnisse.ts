...
export const ERLEBNISSE: Erlebnis[] = [
  {
    ...
    vollBeschreibung:
      "Jede Woche neue Marken. Kostenlos probieren – ohne Kaufzwang. Wer probiert, kauft öfter als wer nur schaut.",
  ...
  },
  {
    ...
    icon: "⭐",
    titel: "Scouts Club",
    kurzBeschreibung: "Du kennst eine Marke, die hier reingehört?",
    vollBeschreibung:
